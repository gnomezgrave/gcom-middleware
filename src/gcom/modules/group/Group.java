...
import gcom.modules.com.CommunicatinMode;
...
public class Group {
    ...
    private CommunicatinMode comMode;
     ...
     * @return the comMode
     */
    public CommunicatinMode getComMode() {
        return comMode;
    }
     ...
     */
    public void setComMode(CommunicatinMode comMode) {
